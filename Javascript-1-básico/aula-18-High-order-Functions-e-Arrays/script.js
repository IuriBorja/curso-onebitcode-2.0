...
// sort altera o elemento original, por isso esta sendo feito sem armazenar o resultado em
//alguma variavel pois seria em vao visto que o valor original vai ser alterado
personagens.sort(function (a, b) {
    return a.nivel - b.nivel
  });


//maneira de usar o sort e manter o valor original da array é usando slice seguido do sort
//slice 

const personagensAlterado = personagens.slice().sort(function(a, b) {
    return a.nivel - b.nivel;
})